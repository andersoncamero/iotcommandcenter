...
export const Controllers: React.FC = () => {
  ...
  const handleController = (controllerID: string) => {
    navigate("/controller", {
      state: { controllerID },
    });
  };
                  ...
                  >
                    <Card typeCard="content" className="space-y-3">
                      ...
                      <div className="flex flex-wrap gap-3 text-xs sm:text-sm">
                        ...
                        <div>
                          <p className="text-slate-500 text-[11px]">Gateways</p>
                      ...
                      <div className="flex items-center justify-between pt-2">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button
                            className="text-xs px-3 py-1.5 rounded-lg bg-[#0794d6] text-white hover:bg-[#0577bb] transition-colors"
                            onClick={() => handleController(controller.ID)}
                          >
                            Controlar
                          </Button>
                        </div>
